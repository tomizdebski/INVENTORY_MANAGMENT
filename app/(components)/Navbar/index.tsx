        ...
        <div className="hidden md:flex justify-between items-center gap-5">
            <div>
                <button onClick={toggleDarkMode}>
                  {isDarkMode ? <Moon className="cusor-pointer text-gray-500" size={24}/> : <Sun className="cusor-pointer text-gray-500" size={24}/>}
            ...
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="font-semibold">TOM i</span>
            </div>
        </div>
        <Link href="/settings">
        <Settings className="cusor-pointer text-gray-500" size={24}/>
        </Link>
